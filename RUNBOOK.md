...
- Autonomous forward movement defaults to positive cruise throttle `+0.65`; `VELOCIDAD-MAX-30` uses throttle `0.50`, `VELOCIDAD-MAX-90` uses throttle `0.70`, and reverse throttle is not emitted by the autonomous controller.
